...
function echoVideoList($feed, $authenticated = false)
{
    ...
    foreach ($feed as $entry) {
		...
		$table .= 
		'<li id="vid'.$videoId.'" class="videoresult">
			<img src="' . $thumbnailUrl. '" alt="'. stripslashes($videoTitle) . '" />
			<h5>'. stripslashes($videoTitle) . '</h5>
			<div class="loadto"><a class="load" href="#" onclick="deckLoad(0, \''.$videoId.'\')">Deck 1</a><a class="load" href="#" onclick="deckLoad(1, \''.$videoId.'\')">Deck 2</a></div>
		</li>';
/*
